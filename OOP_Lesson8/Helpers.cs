...
namespace OOP_Lesson8
{
    public class Helpers
    {
        ...
        /// <returns></returns>
        public (int minValue, int pageSize) GetPagingRange(int pageNo)
        {
        ...
        /// <param name="pageNo">номер страницы</param>
        /// <returns></returns>
        public (List<string> source, List<string> result) CutResultsToRange(List<string> results, int pageNo = 1)
        {
